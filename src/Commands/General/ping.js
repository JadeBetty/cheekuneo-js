        ...
        await interaction.editReply({
            embeds: [
                new EmbedBuilder()
                    ...
                    .addFields(
                        { name: "Ping", value: `Client: ${clientPingEmoji} ${clientPing}ms\n Websocket: ${websocketPingEmoji} ${websocketPing}ms`, inline: true },
                        { name: "Uptime", value: `${hours} hours, ${minutes} mintues`, inline: true }
                    )
                    .setTimestamp()
            ]
        })
